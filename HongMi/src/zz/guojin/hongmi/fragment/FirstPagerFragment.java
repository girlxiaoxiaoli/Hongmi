...
import zz.guojin.hongmi.activity.UserRegistActivity;
...
public class FirstPagerFragment extends BaseFragment2 implements
	...
	TextView tv_time_dami_user; //打米时间
	// (R.id.gridview)
	MyGridView gridview;
	// (R.id.tv_money1)
	...
	public void onItemClick(AdapterView<?> parent, View view, int position,
		...
		case 1:
			...
			// JumpUtil.JumpActivity(getActivity(),
			// MemberreRegistActivity.class); 注册会员
			break;
		case 2:
			// 激活码
		...
		case 4:
			...
			bundle.putInt("id", 3);
			JumpUtil.jumpToActivity(getActivity(), FinanceActivity.class,
					bundle);
		...
		case 8:
			...
			// JumpUtil.jumpToActivity(getActivity(), ClearCapital.class,
			// bundle2);
			JumpUtil.JumpActivity(getActivity(), UserRegistActivity.class);
	...
	public void initView() {
		...
		tv_dami = (TextView) rootView.findViewById(R.id.tv_dami); // 打米
		tv_shoumi = (TextView) rootView.findViewById(R.id.tv_shoumi);// 收米
		tv_time_dami_user =(TextView) rootView.findViewById(R.id.tv_time_dami_user);
		gridview = (MyGridView) rootView.findViewById(R.id.gridview);
		tv_money1 = (TextView) rootView.findViewById(R.id.tv_money1);// 红米钱包
		tv_money2 = (TextView) rootView.findViewById(R.id.tv_money2);// 经理钱包
		tv_money3 = (TextView) rootView.findViewById(R.id.tv_money3);// 推荐钱包
		tv_name_user = (TextView) rootView.findViewById(R.id.tv_name_user);// 会员账号
		tv_id_user = (TextView) rootView.findViewById(R.id.tv_id_user); // 会员id
		tv_grade_user = (TextView) rootView.findViewById(R.id.tv_grade_user);// 会员等级
		tv_exit = (TextView) rootView.findViewById(R.id.tv_exit);// 退出
		shopping = (TextView) rootView.findViewById(R.id.shopping);// 商城
		luck_wheel = (TextView) rootView.findViewById(R.id.luck_wheel);// 转盘
	...
	public void initListener() {
		...
		tv_shoumi.setOnClickListener(this);
		tv_dami.setOnClickListener(this);
		shopping.setOnClickListener(this);
		luck_wheel.setOnClickListener(this);
	...
	public void doWhatForRequest(int what, String info) {
		...
		if (what == 300) {
			try {
				...
				if (data.has("tj_he")) {
					// 推荐钱包
					tj_he = "".equals(data.getString("tj_he")) ? "0" : data
							.getString("tj_he");
				...
				if(data.has("datediff")){
					String datediff = data.getString("datediff");
					MyCountDownTimer myCountDownTimer = new MyCountDownTimer
							(tv_time_dami_user, Long.valueOf(datediff)*1000, 1000,1);
