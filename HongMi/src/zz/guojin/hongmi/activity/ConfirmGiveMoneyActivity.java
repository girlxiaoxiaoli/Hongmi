...
public class ConfirmGiveMoneyActivity extends Activity implements OnClickListener {
		...
		builder.setItems(strs, new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				...
				case 1:
					...
					break;
				case 2:
					Toast.makeText(ConfirmGiveMoneyActivity.this, "关闭对话框", 10).show();
					break;
				}
			}
		});
	...
	public void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (state.equals(Environment.MEDIA_MOUNTED)) {
			...
			if (ConfirmGiveMoneyActivity.this != null) {
		...
		if (requestCode == 1 && resultCode == Activity.RESULT_OK) {
			if (data != null) {
				...
				if (bitmap != null) {
					...
					Toast.makeText(ConfirmGiveMoneyActivity.this, "图片获取失败，请重新选择", 10)
							.show();
				}
				// 保存图片
				try {
					...
					Log.i("1", "flag=" + flag);
					if (flag) {
						Toast.makeText(ConfirmGiveMoneyActivity.this,
						...
						Toast.makeText(ConfirmGiveMoneyActivity.this, "图片保存失败!", 10).show();
			...
			try {
				...
				Cursor c = ConfirmGiveMoneyActivity.this.getContentResolver().query(
	...
	private void showImageDialog(Bitmap b, final String orderNo,
		...
		AlertDialog.Builder builder = new AlertDialog.Builder(ConfirmGiveMoneyActivity.this);

		builder.setTitle("请上传包含交易信息的照片");
		View imgEntryView = View.inflate(ConfirmGiveMoneyActivity.this,
				R.layout.dialog_photo_entry, null); // 加载自定义的布局文件
		ImageView img = (ImageView) imgEntryView.findViewById(R.id.large_image);
		if (b != null) {
			Display display = ConfirmGiveMoneyActivity.this.getWindowManager()
					.getDefaultDisplay();
			...
			Toast.makeText(ConfirmGiveMoneyActivity.this, "获取照片失败", 10).show();
		...
		builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				if (ConfirmGiveMoneyActivity.this != null) {
					// 判断网络
					if (isNetworkConnected(ConfirmGiveMoneyActivity.this)) {
						try {
							/**
							 * 上传照片，没有正确的参数不能正确上传
							 * 
						...
						Toast.makeText(ConfirmGiveMoneyActivity.this, "网络异常，请检查网络!", 10)
								.show();
					}
				}
			}
	...
	public void onClick(View v) {
		...
		Request<String> request = NoHttp.createStringRequest(MUrlUtil.BASE_URL+MUrlUtil.SHE_TO, RequestMethod.POST);
		binary = new FileBinary(outFile);
		request.add("comfir2", temp);
		request.add("tid", extra);
	...
	OnResponseListener<String> responseListener = new OnResponseListener<String>() {
		...
		public void onStart(int what) {
			// TODO Auto-generated method stub
	        	   ...
	        	   pd = ProgressDialog.show(ConfirmGiveMoneyActivity.this, "上传图片中", "Please wait...");
		...
		public void onSucceed(int what, Response<String> response) {
			...
			if (what==390) {
				...
				if ("1".equals(json.getError())) {
					...
					AppManager.getInstance().killActivity(ConfirmGiveMoneyActivity.class);
		...
		public void onFailed(int what, Response<String> response) {
			// TODO Auto-generated method stub
			pd.dismiss();
			ToastUtils.showTextToast(ctx, "图片上传失败...");
		}
